...
export type TotalAssetsHistoricalQuery = {
  __typename?: "Query";
  vaultByAddress: {
    __typename?: "Vault";
    asset: { __typename?: "Asset"; name: string; decimals: number; logoURI?: string | null; symbol: string };
    state?: { __typename?: "VaultState"; totalSupply: any; totalAssetsUsd?: number | null; totalAssets: any } | null;
    historicalState: {
      __typename?: "VaultHistory";
      totalAssetsUsd?: Array<{ __typename?: "FloatDataPoint"; y?: number | null; x: number }> | null;
      totalAssets?: Array<{ __typename?: "BigIntDataPoint"; y?: any | null; x: number }> | null;
    };
  };
};
 ...
 * });
 */
export function useFullVaultInfoQuery(
  baseOptions: Apollo.QueryHookOptions<FullVaultInfoQuery, FullVaultInfoQueryVariables> &
    ({ variables: FullVaultInfoQueryVariables; skip?: boolean } | { skip: boolean })
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<FullVaultInfoQuery, FullVaultInfoQueryVariables>(FullVaultInfoDocument, options);
}
export function useFullVaultInfoLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<FullVaultInfoQuery, FullVaultInfoQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<FullVaultInfoQuery, FullVaultInfoQueryVariables>(FullVaultInfoDocument, options);
}
export function useFullVaultInfoSuspenseQuery(
  baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<FullVaultInfoQuery, FullVaultInfoQueryVariables>
) {
 ...
 * });
 */
export function useTotalSupplyHistoricalQuery(
  baseOptions: Apollo.QueryHookOptions<TotalAssetsHistoricalQuery, TotalAssetsHistoricalQueryVariables> &
    ({ variables: TotalAssetsHistoricalQueryVariables; skip?: boolean } | { skip: boolean })
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<TotalAssetsHistoricalQuery, TotalAssetsHistoricalQueryVariables>(
    TotalAssetsHistoricalDocument,
    options
  );
}
export function useTotalSupplyHistoricalLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<TotalAssetsHistoricalQuery, TotalAssetsHistoricalQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<TotalAssetsHistoricalQuery, TotalAssetsHistoricalQueryVariables>(
    TotalAssetsHistoricalDocument,
    options
  );
}
export function useTotalSupplyHistoricalSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<TotalAssetsHistoricalQuery, TotalAssetsHistoricalQueryVariables>
) {
  const options = baseOptions === Apollo.skipToken ? baseOptions : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<TotalAssetsHistoricalQuery, TotalAssetsHistoricalQueryVariables>(
    TotalAssetsHistoricalDocument,
    options
  );
}
...
export type TotalSupplyHistoricalQueryResult = Apollo.QueryResult<
