...
import { fetchMorphoUserDistributions } from "../queries/user-distributions/UserDistribution.fetch";
...
export const useMutateClaimAllMorphoRewards = () => {
  ...
  const { sendTransactionAsync, ...rest } = useSeamlessSendTransaction({
    queriesToInvalidate: [MorphoQueryKeys.rawMorphoUserRewards(address!, ChainId.BaseMainnet)],
  });
