...
import { FullMorphoInfoData } from "./types/FullMorphoInfoData";
import { fNetApyData } from "./netApyData/fNetApyData";
...
export function mapFullVaultInfo(
  vault: FullVaultInfoQuery["vaultByAddress"],
