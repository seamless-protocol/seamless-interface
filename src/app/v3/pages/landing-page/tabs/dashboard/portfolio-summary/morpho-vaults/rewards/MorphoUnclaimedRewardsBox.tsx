...
import { MorphoUserRewardsData, useMorphoExtendedUserRewards } from "../../../../../../../../statev3/morpho/user-rewards/MorphoUserRewards.hook";
    ...
    <div>
      <FlexCol className="bg-neutral-0 rounded-xl border border-b-100 h-full p-8 justify-between">
        ...
        {disabled ? (
          ...
          <ImageGroup imageStyle="w-6" spacing="-space-x-3" images={rewardData.rewards?.map((reward) => reward.token.logo) || []} />
        )}
      </FlexCol>
    </div>
  );
