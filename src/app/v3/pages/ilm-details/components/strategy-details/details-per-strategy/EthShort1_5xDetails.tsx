    ...
    <FlexCol className="w-full gap-8">
      ...
      <FlexCol className="w-full gap-4">
        ...
        <LocalCollapseArrow>
          ...
          <div className="collapse-content">
            <div>
              <Typography type="regular3"> Yes. As ETH decreases in price in bearish market conditions, returns are magnified. Conversely, losses are
                magnified when ETH increases.</Typography>
            </div>
          </div>
        </LocalCollapseArrow>
