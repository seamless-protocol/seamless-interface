...
export const weETHBooster_3xDetails: React.FC<{
  strategy: Address
}> = ({ strategy }) => {
  return (
    <FlexCol className="w-full gap-8">
      ...
      <FlexCol className="w-full gap-4">
        ...
        <LocalCollapseArrow>
          ...
          <div className="collapse-content">
            <div>
              <Typography type="regular3"> No. Since weETH and ETH are correlated assets, regardless of ETH price movement, you earn staking fees from
                holding a larger weETH balance.</Typography>
            </div>
          </div>
        </LocalCollapseArrow>
