...
export function BlueCoinbaseConnectWalletButton() {
  ...
  return (
    <button className="bg-blue-500 flex items-center px-4 py-[9px] text-white rounded-lg" onClick={createWallet}>
      <CoinbaseWalletLogo />
      <Typography type="medium3">Connect Wallet</Typography>
    </button>
  );
}
