...
import { useFetchViewSupplyIncentives } from "../../../statev3/lending-borrowing/hooks/useFetchViewSupplyIncentives";
import { useFetchStrategyIncentives } from "../../../statev3/loop-strategy/hooks/useFetchViewStrategyIncentives";
import { useFetchStrategyAssets } from "../../../statev3/loop-strategy/metadataQueries/useFetchStrategyAssets";
...
export const LendingIncentivesButton: React.FC<{
  ...
  const { data: supplyIncentives, ...supplyRest } =
...
export const StrategyIncentivesButton: React.FC<{
  ...
  const { data: incentives, ...incentivesRest } =
    useFetchStrategyIncentives(strategy);
...
export const AprTooltip: React.FC<AprTooltipProps> = ({
  isStrategy,
  asset,
}) => {
  return isStrategy ? (
    <StrategyIncentivesButton strategy={asset} />
  ) : (
