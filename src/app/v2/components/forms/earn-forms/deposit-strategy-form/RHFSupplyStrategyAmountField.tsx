...
export function RHFSupplyStrategyAmountField<T>({ overrideUrlSlug, assetAddress, ...other }: IProps<T>) {
  // *** warning *** //
  if (!overrideUrlSlug && !assetAddress) {
    // eslint-disable-next-line no-console
    console.warn(
      "RHFSupplyStrategyAmountField requires either 'overrideUrlSlug' or 'assetAddress' prop to be passed for proper functionality."
    );
  }
