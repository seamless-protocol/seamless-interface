export const StakedTokenAbi = [
  ...
  },
  {
    ...
    name: "decimals",
    inputs: [],
    outputs: [{ name: "decimal", type: "uint8", internalType: "uint8" }],
    stateMutability: "view",
  },
  {
    type: "function",
  ...
  },
  {
    ...
    name: "getCooldown",
    inputs: [],
    outputs: [{ name: "cooldownTime", type: "uint256", internalType: "uint256" }],
    stateMutability: "view",
  },
  {
    type: "function",
    ...
    inputs: [
      ...
      { name: "toBalance", type: "uint256", internalType: "uint256" },
    ],
    outputs: [
      {
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: "scaledSupply", type: "uint256", internalType: "uint256" },
    ],
    stateMutability: "view",
  },
  {
  ...
  },
  {
    ...
    inputs: [],
    outputs: [{ name: "scaledSupply", type: "uint256", internalType: "uint256" }],
    stateMutability: "view",
  },
  {
    type: "function",
  ...
  { type: "error", name: "CooldownNotInitiated", inputs: [] },
  { type: "error", name: "CooldownStillActive", inputs: [] },
  ...
  { type: "error", name: "UnstakeWindowExpired", inputs: [] },
  {
    type: "error",
