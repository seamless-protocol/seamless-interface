export const RewardsControllerAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: "address", name: "reward", type: "address" },
      { indexed: true, internalType: "address", name: "user", type: "address" },
      { indexed: false, internalType: "uint256", name: "oldUserIndex", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "oldRewardsAccrued", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "newUserIndex", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "newRewardsAccrued", type: "uint256" },
    ],
  ...
  { inputs: [], name: "renounceTemporaryOverrideAdmin", outputs: [], stateMutability: "nonpayable", type: "function" },
  {
    inputs: [
      { internalType: "address", name: "user", type: "address" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint128[]", name: "accruedAmounts", type: "uint128[]" },
    ],
    name: "setUserData",
    outputs: [],
    stateMutability: "nonpayable",
